  ...
  <div class="col-md-12">
    ...
    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="80%">
        ...
        <?php
            ...
            echo "<td><a href='form_EditEstacionamiento.php?id_estacionamiento=". $c->get_id_estacionamiento() ." & numero=". $c->get_numero() . " & estado=". $c->get_estado() . "' class='btn btn-xs btn-warning' data-toggle='tooltip' title='Editar'><i class='glyphicon glyphicon-pencil'></i>
