           ...
           <div class="contact-main">
					...
					<h3 class="tittle wow bounceIn"  data-wow-duration=".8s" data-wow-delay=".2s">Ingreso</h3>
						<div class="arrows-three"><img src="../images/border.png" alt="border"></div>
						    <form id="filldetails"  method="POST" action="admin.php">
					  <div class="field name-box">
							<input type="text" id="name" placeholder="Usuario" name="user" required=""/>
							<label for="name">Usuario</label>
							<span class="ss-icon">check</span>
					  </div>
					  
					  <div class="field email-box">
							<input type="text" id="email" placeholder="Password" name="pass" required=""/>
